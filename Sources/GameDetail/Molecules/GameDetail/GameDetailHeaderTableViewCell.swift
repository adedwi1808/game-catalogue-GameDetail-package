...
class GameDetailHeaderTableViewCell: UITableViewCell {
    ...
    private func buildProfileTextLabel(genres: String, releaseDate: String, developers: String) {
        ...
        let genreView = createProfileTextLabelElement(labelText: "genre_label".localized, valuText: genres)
        let releaseDateView = createProfileTextLabelElement(labelText: "release_date_label".localized, valuText: releaseDate)
        let developersView = createProfileTextLabelElement(labelText: "developers_label".localized, valuText: developers)
